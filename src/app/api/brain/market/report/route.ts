...
const LOG = "[Brain/Market/Report]";

/**
 * POST /api/brain/market/report
 * Server-side proxy to brainAI.market.generateReport (apiKeyProcedure).
...
export async function POST(req: NextRequest) {
    try {
        ...
        const result = await brainAI.market.generateReport(body);
